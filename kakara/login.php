...
<!DOCTYPE HTML>
<?php
mysql_connect("adobanyi91.fatcowmysql.com", "adobanyi91", "Adobanyi@123");
	...
	<div class="header">
	  <div class="head-t">
		...
		<ul class="megamenu skyblue">
			...
			<li><a class="color2" href="sell.php">Sell</a></li>
			<li class="grid"><a class="color4" href="login.php">Delete Your Item</a></li>
				...
				<div class="col-md-6 account-left second">
					<form>
						<div class="account-top heading">
							...
							<p>Wehn you log in, you will be able to see items you have posted.</p>
							<p>and you would be able to easily delete them.</p>
						</div>					
					</form>
				</div>
				 </div>
