...
<div class="header_bg">
   <div class="container">
	<div class="header">
	  <div class="head-t">
		 <div class="logo">
			  <a href="admin.php"><h1>Kakara <span>Online Market</span></h1> </a>
		 </div>
		...
		<ul class="megamenu skyblue">
			<li class="active grid"><a  class="color4" href="admin.php">Products</a></li>
			<li><a class="color4" href="inbox.php">Inbox</a></li>
			<li class="grid"><a class="color2" href="">Add Requests</a></li>
			<?php 
					if (isset($_SESSION['username']))
					{ ?>
					<li><a class="color4" href="#"><?php echo $_SESSION['username']; } ?></a></li>
			<li><a class="color4" href="signOutA.php">Log Out</a></li>
...
<?php
if (isset($_SESSION['username']))
{ echo $_SESSION['username']; } else if (!isset($_SESSION['username'])){echo "No session"; }?>
	<div class="products">
		<div class="container">
			...
			<form  method="post" id="report_filter" action="<?= $_SERVER['PHP_SELF'];?>" >
				<select style="margin:0,50;"class="address" name="category" onchange="document.getElementById('report_filter').submit();">
			...
			<form method="post" id="address_change" action="<?= $_SERVER['PHP_SELF'];?>" >
					...
					$term = mysql_real_escape_string($_REQUEST['term']);     
						 ...
						 if ($num_rows!=0){
							...
							<div class="products-grd">
								...
								<br />
							<button><?php echo"<a href='validADelete.php?id=$id'>"."Delete This Item"."</a>"; ?></button>
							</div>
