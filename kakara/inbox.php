	...
	<div class="header">
	  <div class="head-t">
		...
		<!--start-header-menu-->
			...
			<li><a  class="color4" href="admin.php">Products</a></li>
			<li  class="active grid"><a class="color4" href="inbox.php">Inbox</a></li>
			<li class="grid"><a class="color2" href="">Add Requests</a></li>
			<li><a class="color4" href="signOut.php">Log Out</a></li>
...
<!--contact-->
   <div class="contact">
	  <div class="container">
			<h3 class="tittle con">Messages</h3>
			  <table  border="2" style="width:100%">
							<tr>				
								...
								<th><h3>Phone</h3></th>
								<th><h3>Message</h3></th>
								<th><h3>Time Sent</h3></th>	
								<th><h3>Action</h3></th>									
							</tr>
							<?php
								$view = mysql_query("SELECT * FROM contact") or die(mysql_error());
