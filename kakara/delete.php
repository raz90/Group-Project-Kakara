	...
	<div class="header">
	  <div class="head-t">
		...
		<ul class="megamenu skyblue">
			...
			<li class="active grid"><a class="color4" href="signOut.php">logout</a></li>
	...
	<div class="products">
		<div class="container">
			<div class="products-grids">
		     <h3 class="tittle fea">Your Advertised Products</h3>
			 <br />
			 <div class="clearfix"></div>
			 <?php
			 if (isset($_SESSION['email']))
				...
				$query = mysql_query("SELECT * FROM products WHERE email = '$email'")OR DIE (mysql_error());
						...
						<div class="products-grd">
							<div class="p-one simpleCart_shelfItem prd">
								...
								<div class="pro-grd">
									<?php echo "<a href='item.php?id=$id'>"; ?> View My Product</a>
								</div>
							</div>	
							<br />
							<button><?php echo"<a href='validDelete.php?id=$id'>"."Delete This Item"."</a>"; ?></button>
					</div>  <?php } }else {?><p><a href="login.php">sign In To Continue</a></p> <?php }?> 
