			...
			<h3 class="tittle con">Contact Us</h3>
			     <div class="lcontact span_1_of_contact">
				      <div class="contact-form">
				  	        <form action="validContact.php" method="post">
								...
								<p class="comment-form-author"><label>Phone NO:</label>
						     	   <input type="text" name="phone"class="textbox" value="Enter your email here..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}">
						        </p>
